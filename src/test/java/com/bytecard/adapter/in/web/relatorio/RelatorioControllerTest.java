...
class RelatorioControllerTest {
    ...
    class RelatorioDeGastos {

        @Test
        @DisplayName("Deve gerar relatório com categorias e valor total corretamente")
        ...
        @Test
        @DisplayName("Deve lançar exceção quando cartão não existir")
        ...
        @Test
        @DisplayName("Deve lançar exceção quando não houver compras no período")
        ...
        @Test
        @DisplayName("Deve gerar relatório com lista vazia e valor total zero")
        ...
        @Test
        @DisplayName("Deve mapear corretamente as categorias de gasto")
        ...
        @Test
        @DisplayName("Deve chamar use case com número do cartão e mês corretos")
